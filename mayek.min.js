  ...
  landingcalc();
   ...
   var w2 = $(".text-container").width();
    $(".tall-container2").css("height", (w2 + window.innerHeight*1.5 + window.innerWidth+window.innerHeight));
     $(".tall-container3").css("height", (w3 + ($('.box-container5').width()*5)+ window.innerWidth +window.innerHeight+ 70));
...
sectioncalc();
  ...
  var scrollAnime = function(){
    ...
    $(".tall-container1").css("height", (window.innerWidth/1.3) + window.innerHeight);
    var w8 = $(".text-container").width();
     var w2 = $(".letter-container").width();
    $(".tall-container2").css("height", ( window.innerHeight*1.5 + w2*10 +window.innerHeight+window.innerWidth));
    var w3 = $(".text-sec3").width();
    var w5 = $(".text-sec5").height();
     var w4 = $(".imgcol").height();
      var w6 = $(".textcol").height();
    ...
    $(".tall-container4").css("height", w4 + window.innerHeight);
    $(".tall-container6").css("height", w6 + window.innerHeight);
    $(".tall-container8").css("height",  (w8+window.innerWidth+window.innerHeight));


    //document height
    /*var hgt=[];
    for(var h=1; h<7; h++){
     //let b = document.querySelectorAll(".tall-container"+h);
     hgt.push($('.tall-container'+h).height());
    }
    const reducer = (acc, cur) => acc+ cur;
    var dheight = hgt.reduce(reducer) ;*/
...
$('.scroll').addClass('offup');
  ...
  var scrollPosition = $(window).height() + $(window).scrollTop();
      ...
      if((scrollHeight - scrollPosition) / scrollHeight < 0){
        ...
        var x8=((($(".inner-container8").offset().top)) - $(".tall-container8").offset().top); 
   ...
   if((scrollHeight - scrollPosition) / scrollHeight < 0){
    $(".site-header").css("z-index",-1);
         ...
         if ($(".bars.b3").height()<=window.innerHeight){
          ...
          $(".bars").css("height", '100vh');
          $(".letter").css("left", (x2-(window.innerHeight*1.5+$(".letter-container").width()*4))/10);
          console.log((x2-(window.innerHeight*1.5+$(".letter-container").width()*5)))
          $(".text-container").css("left", window.innerWidth - x8); 
      }
...
if (window.innerWidth < 768) {
  dx = (window.innerWidth/2)- ((270)/2);
  dy = (window.innerHeight/2) - ((63)/2);
  wx = 270;
  wh = 63;
}
...
if (window.innerWidth >= 1366) {
  dx = (window.innerWidth/2)- ((300)/2);
  dy = (window.innerHeight/2) - ((70)/2);
  wx = 300;
  wh = 70;
}

function mayekcanvas(){
...
function line1(){
    ...
    var startX = window.innerWidth/1.5;
    var startY = 0;
    var endX = window.innerWidth/3;
    var endY = window.innerHeight;
    if(window.innerWidth <= 200){
    var am = window.innerHeight/.45;
    var amm = window.innerHeight/am;
}
else{
    var am = window.innerHeight/.42;
    var amm = window.innerHeight/am;
}
    var amount = amm;
    var anime =  setInterval(function() {
       ...
       // ctx.save(); 
        ...
        ctx.beginPath();
        ctx.lineCap = 'round';
        ctx.moveTo(Math.floor(startX + (endX - startX) * amm), startY + (endY - startY) * amm);
   ...
   function line2(){
    ...
    var endX = window.innerWidth/3;
    var endY = window.innerHeight;
    if(window.innerWidth <= 224){
    var am = window.innerHeight/.58;
    var amm = window.innerHeight/am;
}
else{
    var am = window.innerHeight/.58;
    ...
    var anime2 =  setInterval(function() {
       ...
       // ctx.save(); 
        ...
        ctx.beginPath();
        ctx.lineCap = 'round';
        ctx.moveTo(startX + (endX - startX) * amm, startY + (endY - startY) * amm);
...
//$(window).on('orientationchange', mayekcanvas);
 mayekcanvas();
...
ctx.beginPath();
ctx.moveTo(0, 0);
ctx.lineTo(window.innerWidth/1.5, 0);
...
if(window.innerWidth < 500){
 $(".cards").css("width", window.innerWidth);
}
...
var relative = 0;
$(window).on('scroll', function() {
 var sz = Math.min(Math.round((($(".inner-container3").offset().top) - $(".tall-container3").offset().top)/5), $(".box-container").width()+1);
...
// DEMO
//if(window.innerWidth > 500
$(".imgcol").css("width", Math.floor($(".imgcol").width())-1);
$(".imgcol").css("position", 'absolute');
          $(".imgcol").css("left", Math.ceil((window.innerWidth/2)-($(".imgcol").width())/2)-1);
...
createCols('cols-container');

if(window.innerWidth >768){
var scont = document.querySelector('.scroll-container4');
var q = scont.querySelectorAll(":scope > .cols");
...
theight += $(".text-sec7").height();
  ...
  var totalheight= theight- $(".text-sec7").height();
  var margin = (window.innerHeight- totalheight)/2;
if(margin>70){
$(".text-sec7-container").css("margin-top", ''+margin+'px');
}
...
var pixelRatio = window.devicePixelRatio || 1;
if(windoe.innerWidth>1366){
  $(".text-sec5").css("font-size", 275/pixelRatio);
}else{
  $(".text-sec5").css("font-size", 250/pixelRatio);
}
$(".text-s6col2").css("font-size", 40/pixelRatio);
$(".texts6").css("font-size", 90/pixelRatio);
//$(".image").css("font-size", 100/pixelRatio);

/*if(pixelRatio>1){
  $(".bars").css("width", 0.5);
  $(".box-container").css("border-right", '0.5px solid white');
  $(".bars").css("width", 0.5);
  $(".bars").css("width", 0.5);
  $(".bars").css("width", 0.5);
}*/
...
var foot = document.querySelector('.cols-container');
var fcols = foot.querySelectorAll(":scope > .cols");
var fh = [10, 15, 20, 15, 10 ];
for(var f=0;  f<fcols.length; f++){
   fcols[f].style.height = ''+fh[f]+ '%';
   fcols[f].style.background = '#02563e'
}
var fcolsmob = foot.querySelectorAll(":scope > .cols-mob");
var fhmob = [15, 20, 15];
var fhmobw = [25, 50, 25];
for(var f=0;  f<fcolsmob.length; f++){
   fcolsmob[f].style.height = ''+fhmob[f]+ '%';
   fcolsmob[f].style.background = '#02563e';
   fcolsmob[f].style.width = ''+fhmobw[f]+ '%';
}
